...
public class EditEventActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		picker1.setCurrentHour(selected.getList().get(0).hour);
		picker1.setCurrentMinute(selected.getList().get(0).minute);
		picker2.setCurrentHour(selected.getList().get(1).hour);
		picker2.setCurrentMinute(selected.getList().get(1).minute);
		picker3.setCurrentHour(selected.getList().get(2).hour);
		picker3.setCurrentMinute(selected.getList().get(2).minute);
