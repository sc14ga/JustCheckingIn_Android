...
public class EmergencyContactListActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter.mInflater = (LayoutInflater) EmergencyContactListActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        while (phones.moveToNext())
        {
          ...
          if(emergencyContactList != null){
        	  for(Contact c : emergencyContactList.getList()){
        		  if(c.getName().equalsIgnoreCase(name) && c.getNumber().equalsIgnoreCase(phoneNumber)){
            		  flag = true;
            		  break;
            	  }
        	  }
